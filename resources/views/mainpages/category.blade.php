            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="left_sidebar_area">
                        ...
                        <aside class="left_widgets p_filter_widgets sidebar_box_shadow" style="display:none;">
                            <div class="l_w_title">
                        ...
                        <aside class="left_widgets p_filter_widgets price_rangs_aside sidebar_box_shadow">
                            ...
                            <input type="hidden" value="{{ csrf_token() }}" id="_token" name="_token" />
                             <input type="hidden" value="{{ Request::segment(2) }}" id="getcatidseg" name="getcatidsegname" />

                            <div class="widgets_inner">
                                <div class="range_item">
                                    <!-- <div id="slider-range"></div> -->
                                    <input type="text" class="price-filter js-range-slider" value="" />
                                    <div class="d-flex align-items-center">
                                        <div class="price_text">
                                            <p>Price : </p>
                                        </div>
                                        <div class="price_value d-flex justify-content-center">
                                            <input type="text" class="js-input-from price-from" id="amount" readonly />
                                            <span>to</span>
                                            <input type="text" class="js-input-to price-to" id="amount" readonly />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-9">
                    <div class="row scp">
                        <div class="col-lg-12">
                          ...
                          <input type="hidden" value="{{ csrf_token() }}" id="_tokenforcart" name="_token" />
                        <?php
                            ...
                            <div class="single_category_product">
                                <div class="single_category_img">
                                    ...
                                    <div class="category_social_icon">
                                     ...
                                     <input type="hidden" class="hidden_pimg" value="{{asset('product_image')}}<?php echo "/".$data->p_image; ?>">
                                    <div class="category_product_text">
                                        <a href="/singleproduct/<?php echo $data->product_id; ?>">
                                            <h5 class="cart_pname"><?php echo $data->p_name; ?></h5></a>
                                        <p class="price_count"><?php echo $data->price; ?></p>
                                        <?php
                                        $isproadded=FALSE;
                                        
                                            foreach($cart_data as $cdata){
                                                if($data->product_id==$cdata->product_id){
                                                    $isproadded=TRUE;
                                         ...
                                         if(Session::has('session_frontuserid')&&$isproadded==FALSE){
                                    
                                        ?>
                                        <a href="javascript:void(0);" class="btnproadd btn btn-primary">Buy Now</a> 
                                        <?php
                                    }
                                    else if($isproadded==TRUE){
                                        ?>
                                     <span style="color:green;">Item added</span>
                                        <?php
                                    }
                                
                           
                                    ?>
                                    <span class="addedtocart" style="color:green;">Item added</span>
                                    </div>
                                </div>
                            </div>
                        </div>
